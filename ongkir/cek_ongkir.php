...
$response = curl_exec($curl);
 ...
 <tbody>
 	<tr>
 		<td><?php echo $data['rajaongkir']['origin_details']['city_name'];?></td>
 		<td><?php echo $data['rajaongkir']['destination_details']['city_name'];?></td>
 ...
 <td align="right"><input type="radio" class="form-control" required onclick="displayResult(this.value)" name="hargaongkir" value="<?php echo (int)($data['rajaongkir']['results'][$k]['costs'][$l]['cost'][0]['value']);?>">Pilih Satu</td>
 </tr>
 <?php
 }
 ?>
