      ...
      <div class="card card-outline card-info">
        ...
        <div class="card-body">
          ...
          <div class="float-right"><a href="cetakpenjualantahunan.php?tanggal=<?= $date ?>-1" target="_blank" class="btn btn-success"><i class="fas fa-print"></i>Cetak Penjualan Tahunan</a></div>
