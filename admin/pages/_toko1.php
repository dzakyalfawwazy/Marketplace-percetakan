      ...
      <div class="card">
        <div class="card-body card-outline card-danger">
          <div class="form-group">
            ...
            <input type="text" name="jenis" class="form-control" id="exampleInputEmail1" placeholder="....">
          </div>
          <div class="form-group">
        ...
        <div class="card-footer">
          <button type="button" id="submitktg" class="btn btn-info float-right"><div class="fas fa-plus"></div> Tambah Data Toko</button>
        </div>
      </div>
    </form>
