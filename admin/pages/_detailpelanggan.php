          ...
          <div class="card-body">
            <form class="form-horizontal">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" readonly id="inputSkills" placeholder="Provinsi" value="<?php $prov=explode(',', $pro['provinsi']); echo $prov[1] ?>">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputSkills" class="col-sm-2 col-form-label">Kabupaten</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" readonly id="inputSkills" placeholder="Kabupaten" value="<?php $kab=explode(',',$pro['kabupaten']); echo $kab[1]; ?>">
                </div>
              </div>
            </form>
          </div><!-- /.card-body -->
