        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              ...
              <input type="text" name="hargabeli" placeholder="..."  readonly value="<?= $data['hargabeli'] ?>" required class="form-control" />
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
           <div class="input-group">
            ...
            <input type="text" name="hargajual" class="form-control"  readonly value="<?= $data['hargajual'] ?>" required placeholder="...">
            <div class="input-group-append">
              <span class="input-group-text">.00</span>
            </div>
          </div>
