      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="index.php?hal=konfirmasitransaksi" class="dropdown-item">
              <i class="fas fa-envelope mr-2"></i> Ada <?= $count_transaksi ?> transaksi yang harus di konfirmasi
            </a>
            <div class="dropdown-divider"></div>
          <?php } else {} ?>
          </div>
