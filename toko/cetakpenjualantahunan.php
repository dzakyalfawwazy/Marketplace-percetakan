      ...
      <div class="container">
        <table width="100%">
          <tr>
            ...
            <td align="center"><h3>Marketplace Toko Percetakan di Kota Padang</h3><h1><?= $datanamatoko['nama_toko'] ?></h1><h3>Laporan Penjualan Tahunan</h3>Alamat : <?= $alamat['nilai']; ?></td>
            <td width="20%"></td>
          </tr>
        </table>
        ...
        <table style="margin-bottom: 15px">
          ...
          <table width="100%" style="margin-top: 30px">
            <tr>
              <td width="70%"></td>
              <td align="center"><div style="margin-bottom: 100px"><?= $alamat['nilai'] ?>, <?= date('d/m/Y');?></div>(Administrator)</td>
            </tr>
          </table>
        </div>
        <!-- jQuery -->
